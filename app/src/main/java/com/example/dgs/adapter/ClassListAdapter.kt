...
import com.example.dgs.model.masterdata.StandardList

class ClassListAdapter (var context: Context, var getClassList: ArrayList<StandardList>?) : BaseAdapter() {


    override fun getItem(p0: Int): Any {
        return getClassList?.get(0)!!.standard_id
    }
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        boardViewHolder.textView?.setText(getClassList!!.get(position).standard)
        return view
    }
